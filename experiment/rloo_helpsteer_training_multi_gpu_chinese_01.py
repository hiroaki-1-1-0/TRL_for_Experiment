...
Uses 22,358 English samples and 22 Chinese samples from HelpSteer3
"""
...
def prepare_datasets(args, tokenizer, rank=0):
    ...
    try:
        ...
        # Filter for English samples (22,358 samples)
        english_dataset = filter_language_samples(dataset, "english", max_samples=22358)
        timeout_handler.check_timeout("after English filtering")

        # Filter for Chinese samples (22 samples)
        chinese_dataset = filter_language_samples(dataset, "chinese", max_samples=22)
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="experiment/models/qwen3_1.7b_rloo_model_chinese_01", help="Output directory")
    ...
    if rank == 0:
        ...
        print(f"  Dataset: nvidia/HelpSteer3 (English: 22,358 + Chinese: 22)")
